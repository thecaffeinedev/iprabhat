const siteMetadata = {
  ...
  author: "Prabhat",
  description:
    "I'm a software engineer 🧑🏻‍💻 based in Hyderabad, India, who enjoys building things.",
  language: "en-us",
  ...
  siteUrl:
    process.env.NODE_ENV === "production"
      ? "https://iprabhat.dev"
      : "http://localhost:3001",
  siteRepo: "https://github.com/TheCaffeineDev/iprabhat",
  ...
  analytics: {
    ...
    googleAnalyticsId: "UA-150491781-1", // e.g. UA-000000-2 or G-XXXXXXX
  },
  newsletter: {
  ...
  comment: {
    ...
    giscusConfig: {
      ...
      repo: "thecaffeinedev/iprabhat",
      repositoryId: "MDEwOlJlcG9zaXRvcnkzNDA1ODQxMjA=",
      category: "Comments",
      categoryId: "DIC_kwDOFEzmuM4CQK3j",
